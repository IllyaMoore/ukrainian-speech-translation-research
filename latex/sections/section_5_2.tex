...
означає наявність спотворень у всіх 12 сегментах корпусу. Високе значення
...
До цієї категорії належать спотворення, що значно змінюють зміст повідомлення:
\begin{itemize}[nosep]
...
Серед виявлених спотворень ідентифіковано 7 критичних помилок, які помітно
...
\hline
Наша\_стратегія seg001 & Crimea & Kryvyi Rih & Політично чутлива помилка \\
\hline
...
\begin{enumerate}
    ...
    \item \textbf{Критичні семантичні помилки}: виявлено 7 помилок, що істотно
    змінюють зміст повідомлення.

    \item \textbf{Помірна когерентність}: середня оцінка 3,2 з 5 вказує на
